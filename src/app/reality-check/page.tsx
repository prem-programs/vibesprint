...
import {
  ...
  Flame, Star, BarChart2, ArrowRight, CheckCircle2,
  Lightbulb, Shield, Rocket, Award, Activity, ArrowLeft
} from "lucide-react";
    ...
    <div className="min-h-screen bg-[#020617] grid-pattern flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <div className="flex justify-start mb-4">
          <Link href="/" className="flex items-center gap-1.5 text-slate-500 hover:text-slate-300 transition-colors text-xs font-medium group">
            <ArrowLeft className="w-3.5 h-3.5 group-hover:-translate-x-0.5 transition-transform" />
            Back to ThinkOS
          </Link>
        </div>
